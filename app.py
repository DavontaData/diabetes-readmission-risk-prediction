...
if st.button("Predict Readmission Risk"):
    ...
    # Insulin Treatment: Down is the reference category.
    if insulin == "No":
...
This patient demonstrates characteristics associated with an increased likelihood
of a 30-day hospital readmission.

This prediction should be interpreted alongside clinical assessment and should
...
This patient demonstrates a lower predicted probability of 30-day hospital
readmission based on the trained machine-learning model.

Clinical judgment should always be considered when making patient-care decisions.
""")
